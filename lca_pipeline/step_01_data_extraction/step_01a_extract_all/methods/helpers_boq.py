...
def extract_quantities(element, entity, ifc_quants_element, psets_element, obb_dimensions, brep_toggle):
    ...
    # ==== Area Calculation ====
    if isinstance(ifc_quants_element, dict):
        if entity in ("IfcSlab", "IfcRoof", "IfcCovering", "IfcStair", "IfcStairFlight", "IfcRamp", "IfcFooting"):
    ...
    if area is None and isinstance(psets_element, dict):
        ...
        try:
            ...
            area_source = "(P2) Pset Quantities"
        except (ValueError, TypeError):
            area = None
    ...
    if area is None and isinstance(obb_dimensions, dict):
        ...
        if obb_values and len(obb_values) == 3:
            ...
            area_source = "(P3) Bounding Box Surface"
    ...
    if length is None and isinstance(psets_element, dict):
        ...
        try:
            ...
            length_source = "(P2) Pset Quantities"
        except (ValueError, TypeError):
            length = None
    ...
    if length is None and isinstance(obb_dimensions, dict):
        ...
        if obb_values and len(obb_values) == 3:
            ...
            length_source = "(P3) Bounding Box Length"
